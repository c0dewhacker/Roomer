...
export enum NotificationType {
  ...
  BOOKING_TRANSFER_EXPIRED = 'BOOKING_TRANSFER_EXPIRED',
  BOOKING_SWAP_REQUESTED = 'BOOKING_SWAP_REQUESTED',
  BOOKING_SWAP_ACCEPTED = 'BOOKING_SWAP_ACCEPTED',
  BOOKING_SWAP_DECLINED = 'BOOKING_SWAP_DECLINED',
  BOOKING_SWAP_EXPIRED = 'BOOKING_SWAP_EXPIRED',
  ...
  BALLOT_WON = 'BALLOT_WON',
  BALLOT_LOST = 'BALLOT_LOST',
}
