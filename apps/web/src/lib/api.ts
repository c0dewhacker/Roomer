...
import { api, BASE, request } from './api-core'
...
export const authApi = {
  ...
  logout: (pushEndpoint?: string) => api.post<{ data: { ok: true } }>('/auth/logout', { pushEndpoint }),
...
export const pushApi = {
  status: (endpoint: string) => api.post<{ data: { subscribed: boolean } }>('/push/status', { endpoint }),
